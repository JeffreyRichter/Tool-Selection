...
// AI Prompt: Convert the tables to a Go map[string][]string:
var toolNameAndPrompts = map[string][]string{
	// Best Practices
	"azmcp-bestpractices-get": {
		"Fetch the latest Azure best practices",
		"Fetch the latest Azure best practices and generate code sample to get a secret from Azure Key Vault",
	},
	...
	"azmcp-keyvault-key-get": {
		"Show me the details of key <key_name> in the key vault <key_vault_account_name>",
	},
	...
	"azmcp-keyvault-secret-get": {
		"Show me the details about the secret <secret_name> in the key vault <key_vault_account_name>",
	},
	...
	"azmcp-redis-cache-list-accesspolicy": {
	...
	"azmcp-servicebus-queue-peek": {
		"Show me the latest message in service bus <service_bus_name> queue <queue_name>",
	},
	...
	"azmcp-servicebus-topic-subscription-peek": {
		"Show me the latest message in service bus <service_bus_name> subscription <subscription_name> for the topic <topic_name>",
	},

	// Azure Storage
	"azmcp-storage-account-list": {
		"List all storage accounts in my subscription",
		"Show me the storage accounts in my subscription",
		"Show me my storage accounts",
	},
	"azmcp-storage-blob-container-list": {
		"List all blob containers in the storage account <account_name>",
		"Show me the blob containers in the storage account <account_name>",
	},
	"azmcp-storage-blob-container-details": {
		"Show me the properties of the storage container files in the storage account <account_name>",
	},
	"azmcp-storage-blob-list": {
		"List all blobs in the blob container <container_name> in the storage account <account_name>",
		"Show me the blobs in the blob container <container_name> in the storage account <account_name>",
	},
	"azmcp-storage-table-list": {
		"List all tables in the storage account <account_name>",
		"Show me the tables in the storage account <account_name>",
	},
}
